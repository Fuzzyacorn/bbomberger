...
public class SidePanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("Mice Eaten: " + game.getMiceEaten(), LARGE_OFFSET, drawY += MESSAGE_STRIDE);
		g.drawString("Mouse Score: " + game.getNextMouseScore(), LARGE_OFFSET, drawY += MESSAGE_STRIDE);
